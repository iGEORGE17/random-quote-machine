    ...
    return (
        ...
        <div id="quote-box" style={
          ...
          <div id="actionButtons">
            <div id="share-icons">
                <a style={{backgroundColor:this.state.accentColor}} href={`twitter.com/intent/tweet?text=${this.state.quote} - ${this.state.author}`} target="_blank" rel="noreferrer" id='tweet-quote'><i className='fa-brands fa-twitter'></i></a>
